...
public class GridOverlayRenderer<H, V, E>  extends AbstractGridRenderer<H, V, E> {
    ...
    @Override
    protected void drawHexagon(Graphics2D g2d, HexagonCoordinate coordinate, HexagonCell<H, V, E> cell, Shape hexagon, Point2D vertexPosition) {
    ...
    @Override
    protected void drawHexagonBorderEdge(Graphics2D g2d, TriangleCoordinate coordinate, E edge, TriangleDirection direction, Point2D lineStart, Point2D lineFinish) {
        if (debugView.displayHexagons()){
    ...
    @Override
    protected void drawEdge(Graphics2D g2d, TriangleCoordinate coordinate, Object edge, TriangleDirection direction, Point2D lineStart, Point2D lineFinish) {
        if (edge != null && selection == edge)
            g2d.setColor(Color.red);
        else
            g2d.setColor(Color.black);
    ...
    @Override
    protected void drawVertices(Graphics2D g2d, TriangleCoordinate coordinate, TriangleCell<V, E> cell, Point2D vertexPosition) {
    ...
    @Override
    protected void drawHexagonCentreVertice(Graphics2D g2d, TriangleCoordinate coordinate, TriangleCell<V, E> cell, Point2D vertexPosition) {
